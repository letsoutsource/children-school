  ...
  return (
    <>
      <style jsx global>{`
        ...
        .animate-facebook-attention {
          animation: facebook-attention 8s ease-in-out infinite;
          animation-delay: 2s;
        }
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
        {/* Facebook Button */}
        <div className="relative flex items-center group/fb">
          {/* Tooltip / Speech Bubble */}
          <div
            className="absolute right-full mr-3 whitespace-nowrap bg-white text-black font-bold uppercase tracking-wider text-xs md:text-sm px-4 py-2 rounded-2xl border-2 border-black shadow-[3px_3px_0px_#000000] pointer-events-none opacity-0 translate-x-4 transition-all duration-300 ease-out group-hover/fb:opacity-100 group-hover/fb:translate-x-0"
          ...
          <a
            href="https://www.facebook.com/share/1ehsEvJQRa/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow us on Facebook"
            className="animate-facebook-attention flex h-16 w-16 items-center justify-center rounded-full border-2 border-black bg-[#1877F2] text-white shadow-[4px_4px_0px_#000000] transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-105 hover:shadow-[6px_6px_0px_#000000] active:translate-y-0 active:scale-100 active:shadow-[2px_2px_0px_#000000]"
          >
            <svg
